document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.suggestions-items').forEach(item => {
        item.addEventListener('click', () => {
            ...
            promptInput.value = text;  // Set the text content of the clicked item in the input
            promptForm.dispatchEvent(new Event('submit'));  // Trigger the submit event of the form
        });
    });
